...
// Source: github.com/firmeve/firmeve/kernel/contract (interfaces: Protocol,HttpProtocol,HttpRoute,HttpRouteGroup,HttpRouter,HttpWrapResponseWriter)
...
type MockHttpWrapResponseWriter struct {
	ctrl     *gomock.Controller
	recorder *MockHttpWrapResponseWriterMockRecorder
}
...
type MockHttpWrapResponseWriterMockRecorder struct {
	mock *MockHttpWrapResponseWriter
}
...
func NewMockHttpWrapResponseWriter(ctrl *gomock.Controller) *MockHttpWrapResponseWriter {
	mock := &MockHttpWrapResponseWriter{ctrl: ctrl}
	mock.recorder = &MockHttpWrapResponseWriterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockHttpWrapResponseWriter) EXPECT() *MockHttpWrapResponseWriterMockRecorder {
	return m.recorder
}

// Header mocks base method
func (m *MockHttpWrapResponseWriter) Header() http.Header {
	m.ctrl.T.Helper()
...
// Header indicates an expected call of Header
func (mr *MockHttpWrapResponseWriterMockRecorder) Header() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Header", reflect.TypeOf((*MockHttpWrapResponseWriter)(nil).Header))
}
...
func (mr *MockHttpWrapResponseWriterMockRecorder) StatusCode() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StatusCode", reflect.TypeOf((*MockHttpWrapResponseWriter)(nil).StatusCode))
}
...
func (mr *MockHttpWrapResponseWriterMockRecorder) Write(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockHttpWrapResponseWriter)(nil).Write), arg0)
}
...
func (mr *MockHttpWrapResponseWriterMockRecorder) WriteHeader(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteHeader", reflect.TypeOf((*MockHttpWrapResponseWriter)(nil).WriteHeader), arg0)
}
